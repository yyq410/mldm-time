...
otu_group.add_argument("-otop", "--otu_top", type=float, default=0.5, \
                       help="Step 2: OTUs of which average sizes in non-zero samples are more than the quantile\
                        will be saved")
otu_group.add_argument("-not0", "--otu_not_zero", type=float, default=0.1, \
...
sample_group.add_argument("-smin", "--sample_min", type=float, default=0.18, \
                          help="Step 4.1: Samples of which sizes are less than the quantile will be removed")
sample_group.add_argument("-smax", "--sample_max", type=float, default=0.02, \
...
class ProcessBiom:
    ...
    def __init__(self, biom_file, meta_file, otu_min, otu_top, otu_not_zero, sample_min, sample_max, result_dir):
        # load biom file
        try:
...
processor = ProcessBiom(args.biom, args.meta, args.otu_min, args.otu_top, args.otu_not_zero, args.sample_min, \
                        args.sample_max, args.result_dir)
